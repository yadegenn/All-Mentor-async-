...
# данные
TOKEN = '7198233895:AAH6hy9BjXlFapBeaznXL-0isZlRI8npKN0'
state_storage = StateMemoryStorage()
bot = AsyncTeleBot(TOKEN, state_storage=state_storage)
scheduler = AsyncIOScheduler()
GROUP_ID = -1002072657872
db_path = "Mails/bot.db"
WORK_CHAT_FILE = 'Mails/work_chat.txt'
    ...
    translators=[
        FluentTranslator(
            ...
            translator=FluentBundle.from_files(
                locale="ru-RU", filenames=["Mails/locales/ru.ftl"]
            )
        ),
    ],
    root_locale="ru"
...
async def handle_start(message, album: list = None, db=None, checker=None):
    ...
    if (is_photo_start):
        await bot.send_photo(message.chat.id, InputFile("Mails/main.png"), caption=welcome_message, parse_mode='HTML')
    else:
...
def setup_logging():
    ...
    error_log_dir = "Mails/logs/errors"
    debug_log_dir = "Mails/logs/debug"
