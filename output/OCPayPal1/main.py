...
# данные
TOKEN = '7317645641:AAHj_E462Lz9hUakAb3etWX5j3IG1gnZqB4'
state_storage = StateMemoryStorage()
bot = AsyncTeleBot(TOKEN, state_storage=state_storage)
scheduler = AsyncIOScheduler()
GROUP_ID = -1002221362102
    ...
    translators=[
        FluentTranslator(
            ...
            translator=FluentBundle.from_files(
                locale="ru-RU", filenames=["OCPayPal1/locales/ru.ftl"]
            )
        ),
    ],
    root_locale="ru"
...
def setup_logging():
    ...
    error_log_dir = "OCPayPal1/logs/errors"
    debug_log_dir = "OCPayPal1/logs/debug"
