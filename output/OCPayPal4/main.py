...
GROUP_ID = -1002178852941
db_path = "OCPayPal4/bot.db"
WORK_CHAT_FILE = 'OCPayPal4/work_chat.txt'
    ...
    translators=[
        FluentTranslator(
            ...
            translator=FluentBundle.from_files(
                locale="ru-RU", filenames=["OCPayPal4/locales/ru.ftl"]
            )
        ),
    ],
    root_locale="ru"
...
async def handle_start(message, album: list = None, db=None, checker=None):
    ...
    if (is_photo_start):
        await bot.send_photo(message.chat.id, InputFile("OCPayPal4/main.png"), caption=welcome_message, parse_mode='HTML')
    else:
...
def setup_logging():
    ...
    error_log_dir = "OCPayPal4/logs/errors"
    debug_log_dir = "OCPayPal4/logs/debug"
